...
return [
    ...
    'blacklist' => [
        storage_path().DIRECTORY_SEPARATOR.'firewall'.DIRECTORY_SEPARATOR.'blacklist.txt',
    ],
    ...
    'whitelist' => [
        storage_path().DIRECTORY_SEPARATOR.'firewall'.DIRECTORY_SEPARATOR.'whitelist.txt',
    ],
